...
export class E_Sublimation_Many2ManyImage extends Component {
    static template = "e_sublimation.Many2ManyImage";
    static components = {
        FileInput,
    };
    static props = {
    ...
    setup() {
        ...
        onWillStart(async () => {
            await loadCSS('/e_sublimation/static/src/library/fancybox/fancybox.css');
            await loadJS('/e_sublimation/static/src/library/fancybox/fancybox.js')
        });
        onMounted(() => {
...
export const many2ManyImage = {
    component: E_Sublimation_Many2ManyImage,
    supportedOptions: [
        {
